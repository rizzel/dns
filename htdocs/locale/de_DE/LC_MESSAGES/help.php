...
<blockquote>http://<?php echo $host; ?>/update.php?recordid=<var>RECORDID</var>&password=<var>PASSWORT</var>&content=<var>CONTENT_FELD</var></blockquote>
<blockquote>http://<?php echo $host; ?>/update.php?recordname=<var>RECORDNAME</var>&addrtype=ipv4&password=<var>PASSWORT</var>&content=<var>CONTENT_FELD</var></blockquote>
<blockquote>http://<?php echo $host; ?>/update.php?recordname=<var>RECORDNAME</var>&addrtype=ipv6&password=<var>PASSWORT</var>&content=<var>CONTENT_FELD</var></blockquote>
</p>
<p>
